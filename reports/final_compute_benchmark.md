...
## Measurements
- Ranking-only wall time: 11.36s
- Peak real RSS/working set: 26.62 MB
...
- 35.45s came from the current `scripts/benchmark.py` run, which wraps ranking with Python `tracemalloc` overhead and writes output.
